...
namespace SeleniumApiAutomation.Tests
{
    ...
    public class DogApiTests : BaseTest
    {
        ...
        public void ValidUrlNavigationTest()
        {
            ...
            dogApiPage.SwitchToNewTab(); 

            Assert.That(dogApiPage.GetCurrentUrl(), Does.StartWith("https://dogapi.dog/api/v2/breeds/"), "URL does not match the expected breed API format.");
        }
